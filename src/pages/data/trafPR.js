    ...
    <div className="flex h-screen">
      ...
      <div className="bg-gray-200 h-screen w-64 flex flex-col">
        <div className="py-4 px-6">
          <h2 className="text-lg font-semibold mb-4">Traffic's Portal</h2>
          <ul>
            <li className="mb-2">
              <a href="/traffic/landingPageTraf" className="text-gray-800 hover:text-gray-600 font-semibold">
                Home
              </a>
            </li>
            <li className="mb-2">
              <a href="/data/trafPR" className="text-gray-800 hover:text-gray-600 font-semibold">
                Pending Request
              </a>
            </li>
            <li className="mb-2">
              <a href="/data/trafRR" className="text-gray-800 hover:text-gray-600 font-semibold">
                Raise Request
              </a>
            </li>
